...
description: Deploy Oppvera Watch on your own VPS with nginx, SSL, and provider auth upload: step by step with copy-paste commands.
---
...
bash <(curl -fsSL https://raw.githubusercontent.com/codetricity/oppvera-watch/main/scripts/setup-vps.sh)
```
...
```bash
git clone https://github.com/codetricity/oppvera-watch /tmp/oppvera-watch
...
```bash
git clone https://github.com/codetricity/oppvera-watch /home/$USER/oppvera-watch
