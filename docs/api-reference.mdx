---
title: Reference
description: Commands, routes, and runtime behavior reference for Oppvera Watch.
---
...
pnpm self-host               # Build from source and start the self-hosted stack
pnpm self-host:build         # Same as self-host (build from cloned repository)
